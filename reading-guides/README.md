...
| 传统 | 锚点 | 状态 |
|---|---|---|
| 古希腊 | [柏拉图《苏格拉底的申辩》](ancient-greek/plato-apology.md) | 已完成 |
| 古希腊 | [柏拉图《游叙弗伦》](ancient-greek/plato-euthyphro.md) | 已完成 |
...
第一轮十七个锚点已经具备作品身份、概念结构、论证、争议和学习任务，状态为“正文已成，待补检验”。它们将在补齐参考分析、闭卷检查并确认无需外部阅读后逐篇升级为“可直接学习”。后续扩展不以凑齐“文明代表”为目标，而依据课程问题、解释争议和实际学习记录逐部增加。
